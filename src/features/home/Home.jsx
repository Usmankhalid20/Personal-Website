...
import GravityBackground from '../../components/effects/GravityBackground';
...
export default function Home() {
  const handleDownloadCV = () => {
    const cvUrl = "/resume/Usman_Khalid_CV.pdf";
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-[80px] lg:text-[88px] font-bold mb-6 leading-[1.1] tracking-tight">
          ...
          <div className="text-2xl md:text-3xl font-medium mt-6 text-gray-600 dark:text-gray-300 flex items-center justify-center lg:justify-start">
          ...
          <motion.p 
            ...
            className="mt-8 text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed"
          >
